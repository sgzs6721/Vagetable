...
<a href="<?php echo site_url('product/add');?>">商品录入</a><br><br>
<a href="<?php echo site_url('product/list_products');?>">查看所有商品</a><br><br><br>
<a href="<?php echo site_url('image/select_category');?>">图片上传</a><br><br><br>
